...
def decoder_funct(filename, content):
    ...
    output_directory = os.path.join(os.getcwd(), "Принято")
...
for act_num in df_postavki['номер поставки']:
    ...
    url = f"https://seller-supply.wildberries.ru/ns/sm-supply/supply-manager/api/v1/supply/acceptedGoodsXLS"
